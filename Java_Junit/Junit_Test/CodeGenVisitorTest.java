...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void image1() throws Exception{
		String prog = "image1";
		String input = prog 
				+ "\nimage g <- \"/Users/lujia/Desktop/LujiaYu_cop5556_fa17/cop5556fa17/ShelterPoint.jpg\"; \n"
//				+ "g <- @ 0;\n"
				+ "g -> SCREEN;\n"
				;
		byte[] bytecode = genCode(input);		
    ...
    //  reads an image from the filename passed as command line argument and displays it.
    //  Compares the image output (and logged) from our language and compares with the same image read directly from the file.
    public void image11() throws Exception{
        String prog = "image11";
        String input = prog
                + "\n image g; \n"
				+ "g <- @ 0;\n"
    ...
    public void imageGenWhite() throws Exception{
    ...
    public void imageGenZ() throws Exception{
    ...
    public void image12() throws Exception{
        String prog = "image12";
        String input = prog +
                "\n int width = 4;" +
                "\nint height = 4;" +
    ...
    public void image41() throws Exception{
        String prog = "image41";
        String input = prog +
                "\nimage[1024,1024] g; " +
                "\nimage[1024,1024] h; " +
	...
	@Test
	public void image51() throws Exception{
		String prog = "image51";
		String input = prog +
				"\nimage[1024,1024] g; " +
                "\nimage[1024,1024] h; " +
    ...
    @Test
    public void image61() throws Exception{
        String prog = "image61";
        String input = prog +
                "\nimage[1024,1024] g; " +
                "\nimage[1024,1024] h; " +
    ...
    @Test
    public void image81() throws Exception{
        String prog = "image81";
        String input = prog +
                "\nimage[1024,1024] g; " +
                "\nimage[1024,1024] h; " +
    ...
    @Test
    public void image91() throws Exception{
        String prog = "image91";
        String input = prog +
                "\nimage[1024,1024] g; " +
                "\nimage[1024,1024] h; " +
    ...
    @Test
    public void image101() throws Exception{
        String prog = "image101";
        String input = prog +
                "\nimage[1024,1024] g; " +
                "\n\nimage[1024,1024] h; " +
                "\ng <- @ 0;" +
